...
const questions = [
    {
        question: "What is Spider-Man's true identity?",
        answers: [
    ...
    {
        question: "Where does Peter Parker work?",
        answers: [
            { text: "Daily Bugle", correct: true },
            { text: "Google", correct: false }
        ]
    }, 

    {
        question: "Was Spider-Man apart of the Avengers?",
        answers: [
